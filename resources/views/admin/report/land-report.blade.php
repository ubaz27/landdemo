        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="signupForm" action = "{{ route('admin.LandStatementExcel') }}" Method = "POST" target="_blank">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <label for="ageSelect" class="form-label">Land Name (Location)</label> <span
                                    class="text-danger">(required)</span>
                                <select class="js-example-basic-single form-select" name="land_id" id="land_id">
                                    <option selected disabled>Select Land Name (Location)</option>
